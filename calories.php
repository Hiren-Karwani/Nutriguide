...
<html lang='en'>
  <head>
    <title> NutriGuide || CALORIES</title>
    ...
    <link rel="stylesheet" href="./caloriesCSS.css">
  </head>
  <!-- Google tag (gtag.js) -->
  ...
  <body>
    ...
    <main>
      ...
      <div class="tracker">
        <h2 id="heading">CALORIE CALCULATOR</h2>
        ...
        <button type="button" class="btn btn-dark submit-btn">TRACK</button><br>
